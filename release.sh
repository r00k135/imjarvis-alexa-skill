...
zip -r target/${packageName}.zip * -x "target/*" ".git/*" ".gitignore" ".jshintrc/*" ".project" ".settings/*" ".tern-project" "npm-debug.log" "release.sh" "private-notes.txt" "imjarvis-alexa-skill.sublime-*" "api-cgi-scripts/*"
